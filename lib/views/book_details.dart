            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 30,),
                  Text("“The Little” is a fairy tale written by the Danish author Rwema. The story follows the journey of a young mermaid who is willing to give up his life in the sea as a mermaid to gain a human soul. The tale was first published in 1837 as part of a collection of fa tales for children.", style: TextStyle(
                    color: Colors.grey,
                    fontSize: 18,
                    letterSpacing: 0.6,
                    wordSpacing: 0.6,
